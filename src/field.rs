...
// FILE MODIFIED FOR TEST PURPOSES: stripped of all `struct`.
...
pub fn add_assign(lhs: &mut [u64; 5], rhs: &[u64; 5]) {
    for i in 0..5 {
        lhs[i] += rhs[i];
    }
}

pub fn add(lhs: [u64; 5], rhs: &[u64; 5]) -> [u64; 5] {
    let mut output = lhs;
    add_assign(&mut output, rhs);
    output
}

pub fn sub_assign(lhs: &mut [u64; 5], rhs: &[u64; 5]) {
    let result = sub(*lhs, rhs);
    *lhs = result;
}

pub fn sub(lhs: [u64; 5], rhs: &[u64; 5]) -> [u64; 5] {
    ...
    reduce([
        (lhs[0] + 36028797018963664u64) - rhs[0],
        (lhs[1] + 36028797018963952u64) - rhs[1],
        (lhs[2] + 36028797018963952u64) - rhs[2],
        (lhs[3] + 36028797018963952u64) - rhs[3],
        (lhs[4] + 36028797018963952u64) - rhs[4],
    ])
}

pub fn mul_assign(lhs: &mut [u64; 5], rhs: &[u64; 5]) {
    let result = mul(*lhs, rhs);
    *lhs = result;
}

#[rustfmt::skip] // keep alignment of c* calculations
pub fn mul(lhs: [u64; 5], rhs: &[u64; 5]) -> [u64; 5] {
...
pub(crate) const fn from_limbs(limbs: [u64; 5]) -> [u64; 5] {
    limbs
}
...
/// The scalar \\( -1 \\).
pub const MINUS_ONE: [u64; 5] = from_limbs([
    2251799813685228,
    2251799813685247,
    2251799813685247,
    2251799813685247,
...
pub fn negate(input: &mut [u64; 5]) {
    // See commentary in the Sub impl
    let neg = reduce([
        36028797018963664u64 - input[0],
        36028797018963952u64 - input[1],
        36028797018963952u64 - input[2],
        36028797018963952u64 - input[3],
        36028797018963952u64 - input[4],
    ]);
    *input = neg;
}
...
pub fn to_bytes(input: [u64; 5]) -> [u8; 32] {
...
#[rustfmt::skip] // keep alignment of c* calculations
pub fn pow2k(input: [u64; 5], mut k: u32) -> [u64; 5] {
...
pub fn square(input: [u64; 5]) -> [u64; 5] {
    pow2k(input, 1)
}

/// Returns 2 times the square of this field element.
pub fn square2(input: [u64; 5]) -> [u64; 5] {
    let mut square = pow2k(input, 1);
    for i in 0..5 {
        square[i] *= 2;
    }
