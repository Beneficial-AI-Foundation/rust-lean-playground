...
namespace zero_sum_checker

/- [zero_sum_checker::FieldElement51]
   Source: 'src/lib.rs', lines 1:0-4:1 -/
structure FieldElement51 where
  limbs : Array U64 5#usize

/- [zero_sum_checker::{zero_sum_checker::FieldElement51}::reduce::LOW_51_BIT_MASK]
   Source: 'src/lib.rs', lines 9:8-9:54 -/
@[global_simps]
...
/- [zero_sum_checker::{zero_sum_checker::FieldElement51}::reduce]:
   Source: 'src/lib.rs', lines 8:4-41:5 -/
